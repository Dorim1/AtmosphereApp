...
fun DayEntryCard(
    ...
    val formatterDayOfWeek = DateTimeFormatter.ofPattern("EEEE", LocalLocale.current.platformLocale)
    val formatterMonth = DateTimeFormatter.ofPattern("MMM", LocalLocale.current.platformLocale)
